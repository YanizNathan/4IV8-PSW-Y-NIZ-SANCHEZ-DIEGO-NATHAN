...
var tamWidth = (134,192,134,163,134,163,134,132,134);

var tamHeight= (163,134,163,134,192,134,163,134,163);

//enviar estis atrubutos oara que se redimensionen las imagenes
...
var oriX= [200,304, 466 , 200, 333 , 437, 200, 304, 466];
var oriY = [100, 100, 100, 233, 204, 233, 337, 366, 337]



//ahora si mi funcion de iman par cuando se coloque de forma erronea la pieza

function iman(){
    for(var i = 0; i< piezas.length; i++){
        if(Math.abs(currentPosX-oriX[i])<15 && Math.abs(currentPosY-oriY[i])<15){
            elementosSeleccionados.setAttribute("x", oriX[i]);
            elementosSeleccionados.setAttribute("y", oriY[i]);
        }
    }
}
...
function testing(){
    ...
    for(var i = 0; i < piezas.length; i++){
        ...
        if(oriX[ide] == posx && oriY[ide] == posy){
