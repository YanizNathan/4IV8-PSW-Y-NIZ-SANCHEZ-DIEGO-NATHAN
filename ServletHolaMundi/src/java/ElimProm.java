...
public class ElimProm extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            id = Integer.parseInt(request.getParameter("ideliminarp"));
            
            //preparo mi sentencia: delete from tabla where atributo = valor
            
            String q = "delete from promociones where id_prom = "+id;
            ...
            out.println("<a class=\"link1\" href='index.html'>Regresar a la pagina principal.</a>"
                        + "<br>"
                        + "<a class=\"link2\" href='ConsulProm'>Consultar promociones.</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
